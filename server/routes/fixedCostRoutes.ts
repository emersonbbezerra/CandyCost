...
router.get(
  '/monthly-total',
  fixedCostController.getMonthlyTotal.bind(fixedCostController)
);
router.get(
  '/by-category',
  fixedCostController.getByCategory.bind(fixedCostController)
);
router.get(
  '/cost-per-hour',
  fixedCostController.getFixedCostPerHour.bind(fixedCostController)
);
...
router.patch(
  '/:id/toggle',
  fixedCostController.toggleActive.bind(fixedCostController)
);
